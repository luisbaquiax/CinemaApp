...
type ReporteAdminSistema = 'populares' | 'comentadas' | 'anuncios-comprados' | 'ganancias-anunciante'
...
const AdminReportesPage = () => {
  const [tipoReporte, setTipoReporte] = useState<ReporteAdminSistema>('populares')
    ...
    <div style={{ padding: '1.5rem', maxWidth: '1200px', margin: '0 auto' }}>
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        <p style={{ fontSize: '.9rem', color: '#94a3b8' }}>
          Analítica general con el estilo visual de los reportes administrativos.
        </p>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1rem', marginBottom: '1.5rem' }}>
        <section style={cardStyle}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '.5rem', marginBottom: '.7rem' }}>
            ...
            <h3 style={{ color: '#f1f5f9', fontSize: '.95rem' }}>Salas Más Populares</h3>
          </div>
          <button
        ...
        <section style={cardStyle}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '.5rem', marginBottom: '.7rem' }}>
            ...
            <h3 style={{ color: '#f1f5f9', fontSize: '.95rem' }}>Salas Más Comentadas</h3>
          </div>
          <button
        ...
        <section style={cardStyle}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '.5rem', marginBottom: '.7rem' }}>
            ...
            <h3 style={{ color: '#f1f5f9', fontSize: '.95rem' }}>Exportación</h3>
          </div>
          <button
            disabled
        ...
        <section style={cardStyle}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '.5rem', marginBottom: '.7rem' }}>
            <BarChart3 size={16} color="#93c5fd" />
            <h3 style={{ color: '#f1f5f9', fontSize: '.95rem' }}>Anuncios Comprados</h3>
          </div>
          <button
        ...
        <section style={cardStyle}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '.5rem', marginBottom: '.7rem' }}>
            <BarChart3 size={16} color="#93c5fd" />
            <h3 style={{ color: '#f1f5f9', fontSize: '.95rem' }}>Ganancias por Anunciante</h3>
          </div>
          <button
